...
Receptor_Cliente01_Sock.settimeout(2) #Definindo limite do temporizador
...
while(True):
    ...
    ack_recebido = False
    # Recebe um Ack, se ele for o ack esperado libera para o envio da prox msg, se nao e ignorado
